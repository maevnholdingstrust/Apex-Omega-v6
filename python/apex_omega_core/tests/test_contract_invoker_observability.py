...
def test_contract_invoker_polygon_send_fails_closed_without_private_mempool(monkeypatch):
    invoker = ContractInvoker("0x1111111111111111111111111111111111111111")
    ...
    with pytest.raises(RuntimeError, match="POLYGON_PRIVATE_MEMPOOL_RPC_URL"):
        invoker._send_signed_transaction(b"\x01", chain_id=137)
