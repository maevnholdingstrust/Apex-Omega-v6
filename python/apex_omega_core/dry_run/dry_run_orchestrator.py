    ...
    def run_cycle(
        ...
        with self._lock:
            ...
            route_details = {
                ...
                "flashloan_asset_symbol": candidate.get("flashloan_asset_symbol"),
                "flashloan_asset_address": candidate.get("flashloan_asset_address"),
                "buy_dex": candidate.get("buy_dex"),
                "sell_dex": candidate.get("sell_dex"),
                "buy_pool": candidate.get("buy_pool"),
                "sell_pool": candidate.get("sell_pool"),
                "buy_price_usd": candidate.get("buy_price_usd"),
                "sell_price_usd": candidate.get("sell_price_usd"),
                "spread_bps": candidate.get("spread_bps"),
                "loan_size_usd": candidate.get("trade_size_usd"),
                "weakest_pool_tvl_usd": candidate.get("weakest_pool_tvl_usd"),
                "buy_pool_tvl_usd": candidate.get("buy_pool_tvl_usd"),
                "sell_pool_tvl_usd": candidate.get("sell_pool_tvl_usd"),
                "pool_usage_fraction": candidate.get("pool_usage_fraction"),
            }
            self._logger.log_c1_card({
                ...
                "route": route_details,
                "size_optimizer": candidate.get("size_optimizer"),
                "flashloan_liquidity": candidate.get("flashloan_liquidity"),
                "payload": {
                    "would_sign": False,
