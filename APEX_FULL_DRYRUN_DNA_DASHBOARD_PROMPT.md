APEX-OMEGA FULL DRY-RUN DNA DASHBOARD PATCH â€” COMPLETE TO FINISH
...
â†’ C1
â†’ fork sim
â†’ shadow execution / payload validation only
â†’ reload or shadow-mutate state
â†’ C2
â†’ fork sim
â†’ shadow execution or NO_OP
â†’ logs/dashboard
...
block_number
  â†’ block_cycle_number
    â†’ global_cycle_number
      â†’ cycle_id
        â†’ opportunity_id
          â†’ C1 DNA card
          â†’ C2 DNA card
          â†’ simulated_net_usd
          â†’ realized_net_opportunity_usd
