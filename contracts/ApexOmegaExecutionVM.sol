...
contract ApexOmegaExecutionVM {
    ...
    constructor(address _aaveV3Pool, address _balancerV2Vault, address _balancerV3Vault) {
    ...
    function _orchestrateRouteAndVerify(
        ...
        _safeTransfer(context.profitAsset, owner, netProfitRealized);
