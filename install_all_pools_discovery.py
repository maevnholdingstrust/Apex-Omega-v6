...
def backup(path: Path):
    if path.exists():
        bak = path.with_suffix(path.suffix + f".bak_all_pools_{STAMP}")
...
write(CORE / "all_pool_discovery.py", r'''
...
write(ROOT / "audit_all_pools.py", r'''
from __future__ import annotations
...
for k, v in {
    "DISCOVER_POOL_FAMILIES": "v2,v3,algebra,curve,balancer",
    "ALL_POOLS_MAX_TOKENS": "100",
    "ALL_POOLS_MAX_PAIRS": "5000",
    "ALL_POOLS_CONCURRENCY": "48",
...
print("[PATCH] .env all-pools discovery defaults set")

for target in [CORE / "all_pool_discovery.py", ROOT / "audit_all_pools.py"]:
    compile_py(target)

print("")
print("[DONE] All-pools discovery scaffold installed.")
print("")
print("Run:")
print("  python .\\audit_all_pools.py")
print("")
print("For wider scan:")
print("  $env:ALL_POOLS_MAX_TOKENS='500'")
print("  $env:ALL_POOLS_MAX_PAIRS='124750'")
print("  python .\\audit_all_pools.py")
